...
public class AntColony {
	...
	public void setQueenPlace(QueenPlace p)
	{
		queenPlace= p;
	}
	/**
	...
	public void deployAnt (Place place, Ant ant) {
		if (food >= ant.getFoodCost()) {
			...
			if (place instanceof Water && ant.watersafe==false) {
				System.out.println("This ant is not waterproof !") ;
			} else {
				place.addInsect(ant);
			}
		}
	...
	public void removeAnt (Place place) {
		if (place.getAnt() != null && place.getAnt().erasable) {
