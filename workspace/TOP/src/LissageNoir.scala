...
object LissageNoir extends App {
  import com.tncy.top.image.ImageWrapper;
  var fileNameO:String="tim2.jpg"
  var fileName:String="Results_Lissage/Lissage tim2.jpg";
...
LissageM(image2D,im2,90)
image2D=copy(im2)
 var outputFile:String="Results_Lissage/LissageM8"+" "+fileNameO
